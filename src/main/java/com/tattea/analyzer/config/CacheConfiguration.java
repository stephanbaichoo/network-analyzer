...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tattea.analyzer.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tattea.analyzer.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.tattea.analyzer.domain.User.class.getName());
            ...
            createCache(cm, com.tattea.analyzer.domain.Host.class.getName());
