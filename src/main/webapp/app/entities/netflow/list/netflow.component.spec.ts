...
describe('Netflow Management Component', () => {
  let comp: NetflowComponent;
  let fixture: ComponentFixture<NetflowComponent>;
  let service: NetflowService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'netflow', component: NetflowComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(NetflowComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.netflows?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
