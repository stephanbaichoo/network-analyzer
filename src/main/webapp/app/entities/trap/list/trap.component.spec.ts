...
describe('Trap Management Component', () => {
  let comp: TrapComponent;
  let fixture: ComponentFixture<TrapComponent>;
  let service: TrapService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'trap', component: TrapComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TrapComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.traps?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
