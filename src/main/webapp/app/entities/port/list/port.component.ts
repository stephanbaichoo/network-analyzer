...
export class PortComponent implements OnInit {
  ...
  trackId(_index: number, item: IPort): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IPort[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
